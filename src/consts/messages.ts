...
export const LAST_SEARCHED_TERM_MSG = 'Last searched term:';
export const ACCESS_TOKEN_REQUIRED_MSG = 'A GitHub personal access token must be provided';
...
export const REPO_SYNC_SUCCESS_MSG = 'was syncronized with success!';
